...
// A propósito NO oculta a los ocupados (ver useAreaOperators) — el
// supervisor decide igual, la disponibilidad es solo información.
export function SummonOperatorButton({ processCode, onSelect }: Props) {
  ...
  return (
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverTrigger asChild>
        ...
        <button
          type="button"
          className="flex items-center gap-1.5 rounded-lg bg-white/5 px-2.5 py-1 text-xs font-medium text-neutral-300 transition-colors hover:bg-white/10"
        >
          <Users size={13} />
          Convocar
        </button>
